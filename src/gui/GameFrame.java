...
public class GameFrame extends JFrame {
    ...
    private void registerActions() {
        attackButton.addActionListener(event -> runAction(gameEngine.attackFlea()));
        trainButton.addActionListener(event -> runAction(gameEngine.trainDefender()));
        vitaminButton.addActionListener(event -> runAction(gameEngine.buyVitamin()));
        skipButton.addActionListener(event -> runAction(gameEngine.skipTime()));
        restartButton.addActionListener(event -> restartGame());
    }

    private void runAction(String message) {
        appendLog(message);
